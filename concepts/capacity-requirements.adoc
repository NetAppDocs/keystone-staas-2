...
[.lead]
The capacity requirements for Keystone STaaS performance service levels differ among the file, block, object, and cloud storage offerings supported by the Keystone STaaS subscription.
