...
##The displayed consumption represents the total usage across both sites. The 94.21 TiB is actively used across both MetroCluster sites, with the consumption split equally between them. To learn about pricing and charging for the advance data protection add-on service, refer to link:../concepts/adp.html#pricing-and-charging[Pricing and charging].##
