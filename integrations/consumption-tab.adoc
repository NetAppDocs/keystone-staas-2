...
##The displayed consumption of 94.21 TiB represents the usage for the primary subscription. Given that advanced data protection splits consumption between partner sites with separate subscriptions, this chart shows only the primary site usage. To learn about pricing and charging for the advanced data protection add-on service, refer to link:../concepts/adp.html#pricing-and-charging[Pricing and charging].##
